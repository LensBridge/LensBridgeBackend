package com.ibrasoft.minbar.dto.board.agent;
 ...
 * <p>
 * The signature covers a fixed canonical string. See {@link com.ibrasoft.minbar.service.agent.handshake.AuthSignaturePayload}.
 */
@Getter
@Setter
