...
import com.ibrasoft.minbar.shared.storage.R2StorageService;
...
import com.ibrasoft.minbar.signage.repository.PosterRepository;
...
public class PosterService {
     ...
     */
    public List<com.ibrasoft.minbar.signage.model.frames.FrameDefinition> getActivePosterFrameDefinitions(Audience audience) {
        return posterRepository.findActivePostersForAudienceAt(Instant.now(), audience)
                .stream()
     ...
     */
    private com.ibrasoft.minbar.signage.model.frames.FrameDefinition toFrameDefinition(Poster poster) {
