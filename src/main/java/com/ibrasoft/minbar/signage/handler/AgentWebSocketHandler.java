package com.ibrasoft.minbar.signage.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ibrasoft.minbar.signage.dto.agent.AuthFrame;
import com.ibrasoft.minbar.signage.dto.agent.CommandAckFrame;
import com.ibrasoft.minbar.signage.dto.agent.CommandProgressFrame;
import com.ibrasoft.minbar.signage.dto.agent.CommandResultFrame;
import com.ibrasoft.minbar.signage.dto.agent.HeartbeatFrame;
import com.ibrasoft.minbar.signage.dto.agent.IncomingAgentFrame;
import com.ibrasoft.minbar.signage.dto.agent.OutgoingAgentFrame;
import com.ibrasoft.minbar.signage.model.Device;
import com.ibrasoft.minbar.signage.repository.DeviceRepository;
import com.ibrasoft.minbar.signage.service.agent.AgentSession;
import com.ibrasoft.minbar.signage.service.agent.AgentSessionRegistry;
import com.ibrasoft.minbar.signage.service.agent.CommandDispatcher;
import com.ibrasoft.minbar.signage.service.agent.HeartbeatService;
import com.ibrasoft.minbar.signage.service.agent.events.DeviceEventPublisher;
import com.ibrasoft.minbar.signage.service.agent.handshake.AuthSignaturePayload;
import com.ibrasoft.minbar.signage.service.agent.handshake.Ed25519Verifier;
