package com.ibrasoft.minbar.signage.dto.agent;
 ...
 * <p>
 * The signature covers a fixed canonical string. See {@link com.ibrasoft.minbar.signage.service.agent.handshake.AuthSignaturePayload}.
 */
@Getter
@Setter
