...
import com.ibrasoft.minbar.repository.sql.PosterRepository;
...
public class PosterService {
     ...
     */
    public List<com.ibrasoft.minbar.model.board.frames.FrameDefinition> getActivePosterFrameDefinitions(Audience audience) {
        return posterRepository.findActivePostersForAudienceAt(Instant.now(), audience)
                .stream()
     ...
     */
    private com.ibrasoft.minbar.model.board.frames.FrameDefinition toFrameDefinition(Poster poster) {
